	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			<ul class = "nav nav-pills">
				...
				<li><a href = "record.php"><span class = "glyphicon glyphicon-book"></span> Records</a></li>
			</ul>
			<br />
			<div class = "alert alert-info">Home</div>
			<div class = "well col-lg-12">
				<img src = "images/logo.png" height="170px" width="170px"/>
			<br />
			<br />	
			<br />	
			</div>
		...
		<div class = "navbar navbar-fixed-bottom alert-warning">
			<div class = "container-fluid">
				<label class = "pull-left">&copy; Attendance System</label>
				<label class = "pull-right">Developed: <a href = "">WADELLA</a></label>
			</div>	
		</div>	
	</body>
